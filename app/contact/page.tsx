...
export default function ContactPage() {
  ...
  return (
    <>
      <section className="pt-32 pb-16 min-h-[80vh]">
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <ScrollReveal>
              ...
              <div className="space-y-6">
                ...
                >
                  <div className="w-12 h-12 rounded-full bg-[var(--color-cyan)]/10 flex items-center justify-center group-hover:bg-[var(--color-cyan)]/20 transition-colors">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-ink)]">Hanoi, Vietnam</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[var(--color-ink)]">(+84) 345 205 918</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal>
              <motion.div
                variants={fadeInUp}
                className="bg-white p-8 rounded-2xl border border-[var(--color-cream-dark)]"
              >
                {isSubmitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-lg border border-[var(--color-cream-dark)] focus:outline-none focus:ring-2 focus:ring-[var(--color-cyan)] focus:border-transparent transition-all"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 rounded-lg border border-[var(--color-cream-dark)] focus:outline-none focus:ring-2 focus:ring-[var(--color-cyan)] focus:border-transparent transition-all resize-none"
